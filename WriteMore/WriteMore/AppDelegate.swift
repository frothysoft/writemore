...
class AppDelegate: NSObject, NSApplicationDelegate {
  ...
  var projectWindowManager: ProjectWindowManager! = ProjectWindowManager()
  var projectStore: CoreDataProjectStore! = nil
  var wordCountStore: CoreDataWordCountStore! = nil
  
  func configureObjects() {
    projectStore = CoreDataProjectStore(managedObjectContext: managedObjectContext!)
    wordCountStore = CoreDataWordCountStore(managedObjectContext: managedObjectContext!)
  }
  ...
  func applicationDidFinishLaunching(aNotification: NSNotification) {
    ...
    if let dvc = dashboardViewController {
      ...
      dvc.configureViewController()
    } else {
      assertionFailure("dashboard controller could not load")
    }
  }
  ...
  lazy var applicationDocumentsDirectory: NSURL = {
    ...
    return appSupportURL.URLByAppendingPathComponent("com.frothysoft.WriteMore")
    }()
  
  lazy var managedObjectModel: NSManagedObjectModel = {
    // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
    let modelURL = NSBundle.mainBundle().URLForResource("WriteMore", withExtension: "momd")!
